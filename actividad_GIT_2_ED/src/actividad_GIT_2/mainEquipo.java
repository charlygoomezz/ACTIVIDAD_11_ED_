...
public static void main(String[] args) {
		...
		System.out.println(arrayEquipos.length);
		...
		for (int i = 0; i < arrayEquipos.length; i++) {
			...
			System.out.println("El equipo '" + arrayEquipos[i].nombre + "' es apto? " + arrayEquipos[i].cantidadJugadoresEsApto());
			System.out.println();
		...
		private static void pedirDatosEquipo(Equipo equipo, Scanner scanner) {
			...
			System.out.println("Ingresa un [Nombre de Equipo]:");
